...
public class CaptchaUtils {
    ...
    // 验证码字体集
    private static final Font[] CAPTCHA_FONT_FAMILY = { new Font("Georgia", Font.BOLD, FONT_SIZE),
            new Font("Garamond", Font.BOLD, FONT_SIZE), new Font("Verdana", Font.BOLD, FONT_SIZE),
            new Font("Arial Unicode MS", Font.BOLD, FONT_SIZE), new Font("Consolas", Font.BOLD, FONT_SIZE),
    ...
    private static void addCaptcha(Graphics2D g2d, String code) {
        ...
        for (int i = 0; i < code.length(); ++i) {
            ...
            double theta = Math.toRadians(random.nextInt(-MAX_ANGEL_OF_ROTATION, MAX_ANGEL_OF_ROTATION));
